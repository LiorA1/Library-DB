...
public class Driver 
{
	public static void main(String []args)  
	{
		...
		one.dbDriver("+ Barak 026803151");
		one.dbDriver("+ Trump 026603151");
		one.dbDriver("+ Stav 036804151");
		one.dbDriver("+ Levy 016803151");
		one.dbDriver("+ Nir 026803999");
		one.dbDriver("+ Moshe 026893151");
		//11 members added.
		...
		one.dbDriver("   Stav        036804151       AX1271       +   ");//borrow 1 book.
		...
		*/
		...
		one.dbDriver("   Stav 036894151       AX1277       +   ");//4
